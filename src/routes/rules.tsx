...
const categories = [
  {
    name: "Object",
    description: "Describe a physical thing — anything you can touch or see.",
  },
  {
    name: "Nature",
    description: "Animals, plants, weather, geography — the natural world.",
  },
  { name: "Random", description: "Could be anything. Stay sharp." },
  {
    name: "Person",
    description:
      "Real or fictional — describe the person without saying their name.",
  },
  {
    name: "Action",
    description: "A verb or activity — describe what someone does.",
  },
  {
    name: "World",
    description: "Countries, cities, landmarks — places on the map.",
  },
];
      ...
      <div className="max-w-2xl mx-auto px-4 py-12 space-y-10">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-lg">
            Articulate is a fast-talking team game. Describe as many words as
